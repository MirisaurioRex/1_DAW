...
// Ejercicio 4.3.3.1 - Modificación del ejercicio 4.3.2.1 para añadir una nueva estructura para guardar la duración en minutos y segundos

using System;

public class Ejercicio_4_3_3_1
{
	// Estructura para la duración (minutos y segundos)
	struct duracion
	{
		public int minutos;
		public int segundos;
	...
	// Estructura para los datos de la canción (incluyendo la duración)
	struct cancion
	{
			...
			switch(opcion)
			{
				...
				case 1:
					if (cantidad == MAX_CANCIONES)
					{
						...
						canciones[cantidad].tiempo.minutos = Convert.ToInt32(Console.ReadLine());
						Console.WriteLine("Escribe los segundos de la canción");
						canciones[cantidad].tiempo.segundos = Convert.ToInt32(Console.ReadLine());
				...
				case 2:
					if (cantidad == MAX_CANCIONES)
					{
						...
						if (posicion < 1 || posicion > cantidad)
						{
							...
							Console.WriteLine("Escribe los minutos de la canción");
							canciones[posicion-1].tiempo.minutos = Convert.ToInt32(Console.ReadLine());
							Console.WriteLine("Escribe los segundos de la canción");
							canciones[posicion-1].tiempo.segundos = Convert.ToInt32(Console.ReadLine());
							Console.WriteLine("Escribe el tamaño en KB");
				...
				case 4:
					// Listado de canciones actual
					Console.WriteLine("Listado de canciones:");
					for (int i = 0; i < cantidad; i++)
					{
						Console.WriteLine("{0}. {1} / {2} / {3}:{4} / {5} KB", i+1, canciones[i].artista, canciones[i].titulo, canciones[i].tiempo.minutos, canciones[i].tiempo.segundos, canciones[i].tamano);
					}
